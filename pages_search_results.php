...
<head>
    ...
    <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Search Results')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'Pages', 'title' => 'Search Results')); ?>
                                            ...
                                            <div class="row g-2">
                                                <div class="col">
                                                    <div class="position-relative mb-3">
                                                        ...
                                                        <a class="btn btn-link link-success btn-lg position-absolute end-0 top-0 material-shadow-none" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample"><i class="ri-mic-fill"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                                                            ...
                                                            <div class="d-sm-flex">
                                                                ...
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge bg-success-subtle text-success fs-11">Business</span></li>
                                                                    </ul>
                                                    ...
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                ...
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge bg-warning-subtle text-warning fs-11">Development</span></li>
                                                                    </ul>
                                                    ...
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <div class="d-sm-flex">
                                                                ...
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge bg-primary-subtle text-primary fs-11">Product</span></li>
                                                                    </ul>
