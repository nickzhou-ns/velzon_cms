                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-auto">
                                                <div class="hstack gap-1 flex-wrap mt-4 mt-md-0">
                                                    <button type="button" class="btn btn-icon btn-sm btn-ghost-warning fs-16 material-shadow-none">
                                ...
                                <div class="col-lg-12">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div class="flex-shrink-0">
                                            <a href="#!" class="btn btn-ghost-success material-shadow-none">View All <i class="ri-arrow-right-line ms-1 align-bottom"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4">
